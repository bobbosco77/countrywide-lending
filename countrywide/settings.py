"""
Django settings for countrywide project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'borrowers.context_processors.company_settings',
            ],
        },
    },
]

WSGI_APPLICATION = 'countrywide.wsgi.application'
